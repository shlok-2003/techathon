...
>(({ className, children, ...props }, ref) => {
    ...
    return (
        <Button
            ref={ref}
            className={cn(
                'bg-rich-yellow-50 fixed bottom-6 right-6 z-50 box-border flex aspect-square h-9 cursor-pointer items-center justify-center rounded-md p-0 duration-300 ease-in-out hover:animate-bounce',
